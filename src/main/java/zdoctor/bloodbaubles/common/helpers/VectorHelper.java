...
public class VectorHelper {
	...
	public static boolean isPlayerNearTileEntity(EntityPlayer player, TileEntity entity, int scanRadius) {
		return scanRadius > getTrueDist((int) player.posX, (int) player.posY, (int) player.posZ, entity.getPos().getX(),
