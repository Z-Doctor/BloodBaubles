...
public class ItemCraftedEvent extends SubEvent<ISubCrafting> {
	...
	public void itemCraftedEvent(net.minecraftforge.fml.common.gameevent.PlayerEvent.ItemCraftedEvent e) {
	 ...
	 * @param block
	 */
	public static void cycleThroughGrid(IInventory craftMatrix, Predicate<ItemStack> modfier, Consumer<Integer> block) {
